...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dgv->GridColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(48)), static_cast<System::Int32>(static_cast<System::Byte>(71)),
				static_cast<System::Int32>(static_cast<System::Byte>(94)));
			this->dgv->Location = System::Drawing::Point(0, 466);
			this->dgv->Name = L"dgv";
			this->dgv->Size = System::Drawing::Size(1453, 228);
			...
			this->testpanel->Location = System::Drawing::Point(527, 536);
			...
			this->datearecup->Location = System::Drawing::Point(138, 95);
			...
			this->datecrecup->Location = System::Drawing::Point(185, 95);
			...
			this->prenomrecup->Location = System::Drawing::Point(91, 95);
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (nom->Text != "" || prenom->Text != "" || labelanni->Text != "" || labelcom->Text != "" || nomr->Text != "" || numr->Text != "" || numh->Text != "" || ville->Text != "") {
		if (MessageBox::Show(n, "Vérification", MessageBoxButtons::YesNo, MessageBoxIcon::Question) == System::Windows::Forms::DialogResult::Yes) {
			this->oSvc->updatepersonne(this->nom->Text,this->prenom->Text,this->labelanni->Text,this->labelcom->Text,this->nomrecup->Text,this->prenomrecup->Text,this->datearecup->Text,this->datearecup->Text);
		};
